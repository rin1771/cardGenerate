...
function generateEmployeeCard($id, $name_kh, $name_en, $position, $star_date, $expired_date, $uploadedFileName, $imageBase64)
{
    ...
    return '
        <div class="card-buva-holder" id="card-buva-holder' . $id . '">
            <div class="container">
                ...
                <div class="hover-buttons">
                    ...
                    <button class="show-price" onclick="window.location.href=\'templates/detail/buva_sea.php?id=' . $id . '&file=' . urlencode($uploadedFileName) . '\';">Print</button>
                </div>
